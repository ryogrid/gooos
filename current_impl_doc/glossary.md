...
This index is generated from all Markdown files in the repository by matching words with two or more uppercase letters.
...
Treat this as a snapshot index that should be regenerated manually when Markdown content changes significantly.
